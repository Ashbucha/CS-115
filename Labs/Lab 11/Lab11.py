...
def testInsert(ins):
    ...
    #The print numbers tell me if the they pass the tests.
...
def testV1():
    ...
    print()
    print("TestV1 Complete")
    print()

def testV2():
    testSort(insertSortV2)
    print()
    print("TestV2 Complete")
    print()
...
#letterCounts([(17293, 'non-letter'), (1927, 'e'), (1606, 'a'), (1331, 'o'), (1250, 'r')])
