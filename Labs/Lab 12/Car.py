...
class Car(object):
    ...
    def __init__(self, make, model, mpg, tank_capacity):
        '''A constructor that identify's the private variables in the class'''
        self.__make = make
        self.__model = model
        self.__mpg = mpg
    ...
    def get_tank_capacity(self):
        '''Returns tank capacity of the car'''
        return self.__tank_capacity

    '''Write setters for mpg and tank_capacity.'''
    def set_mpg(self, mpg):
        '''Sets a new value for mpg'''
        self.__mpg = mpg

    def set_tank_capacity(self, tank):
        '''Sets a new value for tank capacity'''
    ...
    def get_total_range(self):
        '''Returns the total distance the car can travel with a full tank'''
...
class HybridCar(Car):  
    ...
    def __init__(self, make, model, mpg, tank_capacity, battery_kWh, miles_per_kWh):
        '''A constructor that identify's the private variables in the class. Imports the variables from the parent function.'''
    ...
    def get_total_range(self):
        '''Returns the total distance the car can travel with a fully charged battery + its total range from the parent function.'''
