...
class Test(unittest.TestCase):
    ...
    def test05(self):
        ...
        try:
            ...
            self.assertEqual(sys.stdout.getvalue().strip(), '00010000')
            sys.stdout.close()
            sys.stdout = StringIO()
            lab6.count('00000000', 4)
            self.assertEqual(sys.stdout.getvalue().strip(), '00000000\n00000001\n00000010\n00000011\n00000100')
            sys.stdout.close()
            sys.stdout = StringIO()
            lab6.count('11111110', 5)
            self.assertEqual(sys.stdout.getvalue().strip(), '11111110\n11111111\n00000000\n00000001\n00000010\n00000011')
        finally:
            sys.stdout.close()
